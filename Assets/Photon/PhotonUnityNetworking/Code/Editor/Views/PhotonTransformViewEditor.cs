...
namespace Photon.Pun
{
    ...
    public class PhotonTransformViewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.indentLevel += 2;
            view.m_Animate = EditorGUILayout.ToggleLeft(" Animate", view.m_Animate);
            view.m_UseWorldTransform = EditorGUILayout.ToggleLeft(" Use World Transformation", view.m_UseWorldTransform);
            EditorGUI.indentLevel -= 2;
